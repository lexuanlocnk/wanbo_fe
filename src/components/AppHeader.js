    ...
    <Navbar expand="lg" className="custom-navbar px-3 ">
      <Container fluid>
        <DropdownButton id="dropdown-basic-button" title="Danh mục sản phẩm">
            ...
            <Dropdown.Item href="#/action">Ống kính
                <Dropdown className="sub-dropdown">
        ...
        <Navbar.Collapse id="navbarScroll">
            <Nav
                ...
                navbarScroll
            >
            <Nav.Link href="#b8" className='Home' >
                Trang chủ
            </Nav.Link>

            <NavDropdown title="Sản phẩm" href="#action" className='Home'>
               <NavDropdown.Item href="#action1">Wanbo T Series</NavDropdown.Item>
               <NavDropdown.Item href="#action2">Wanbo X Series</NavDropdown.Item>
               <NavDropdown.Item href="#action3">Davinci Series</NavDropdown.Item>
               <NavDropdown.Item href="#action4">Mozart Series</NavDropdown.Item>
               <NavDropdown.Item href="#action5">Phụ Kiện</NavDropdown.Item>
            </NavDropdown>

            <Nav.Link href="#bđ" className='Home' >
                Giới thiệu
            </Nav.Link>

            <Nav.Link href="#b" className='Home' >
                Tin tức
            </Nav.Link>

            <Nav.Link href="#a" className='Home' >
                Liên hệ
            </Nav.Link>
          </Nav>
