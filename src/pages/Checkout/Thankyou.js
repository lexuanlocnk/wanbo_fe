  ...
  const fetchOrder = async () => {
    try {
      ...
      const response = await axios.get(
        `http://192.168.245.190:8002/api/member/information-order`,
        {
          headers: {
      ...
      <Row style={{ backgroundColor: "white", justifyContent: "space-evenly" }}>
        <Col lg={7} xs={12} className="p-4 ">
          <div className=" d-flex align-items-center ">
            <i
              className="bi bi-check-circle me-4"
              style={{ fontSize: 80, color: "green" }}
            ></i>
            <div className=" ">
              <h6 className="fw-bold">CÁM ƠN BẠN ĐÃ ĐẶT HÀNG</h6>
              <p>
                Một email xác nhận đã được gửi tới {orderInfo?.d_gmail}
                <br />
            ...
            <Card.Body>
              ...
              <Row>
                ...
                <Col
                  ...
                  className="text-end"
                >
                  {orderInfo.total_cart
                    ? `${orderInfo.total_cart.toLocaleString("vi-VN")} đ`
                    : ""}
                </Col>
              </Row>
              ...
              <Row>
                ...
                <Col
                  ...
                  className="text-end"
                >
                  {orderInfo.CouponDiscout
                    ? `${orderInfo.CouponDiscout.toLocaleString("vi-VN")} đ`
                    : "0"}
                </Col>
              </Row>
        ...
        <div className="d-flex  justify-content-center">
          <Button className="my-5 mx-2" onClick={() => navigate("/home")}>
            Tiếp tục mua hàng
          </Button>
          <button
            className="my-5 mx-2"
          ...
          >
            {" "}
            <i className="bi bi-printer me-2"></i>IN
          </button>
        </div>
      </Row>
    </div>
